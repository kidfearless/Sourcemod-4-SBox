 ...
 * @section Trace masks.
 */
public const int MASK_ALL = (0xFFFFFFFF); 
...
typeset TraceEntityFilter
{
	 ...
	 */
	function bool (int entity, int contentsMask) { throw new NotImplementedException(); }
	 ...
	 * @return              True to allow the current entity to be hit, otherwise false.
	 */
	function bool (int entity, int contentsMask, any data) { throw new NotImplementedException(); }
};

typeset TraceEntitypublic enumerator
{
	/**
	 ...
	 */
	function bool (int entity) { throw new NotImplementedException(); }
	 ...
	 * @param data          Data value, if used.
	 * @return              True to continue public enumerating, otherwise false. */
	function bool (int entity, any data) { throw new NotImplementedException(); }
}
 ...
 */
public static int TR_GetPointContents(float[] pos[3], ref int entindex=-1) { throw new NotImplementedException(); }
 ...
 * @return              Contents mask.
 */
public static int TR_GetPointContentsEnt(int entindex, float[] pos[3]) { throw new NotImplementedException(); }
 ...
 */
public static void TR_TraceRay(float[] pos[3],
                        float[] vec[3],
                        int flags,
                        RayType rtype) { throw new NotImplementedException(); }
 ...
 * @param flags         Trace flags.
 */
public static void TR_TraceHull(float[] pos[3],
                         float[] vec[3],
                         float[] mins[3],
                         float[] maxs[3],
 ...
 */
public static void TR_public enumerateEntities(float[] pos[3],
                                 float[] vec[3],
                                 int mask,
                                 RayType rtype,
                                 TraceEntitypublic enumerator public enumerator,
                                 any data=0) { throw new NotImplementedException(); }
 ...
 * @param data          Arbitrary data value to pass through to the public enumerator.
 */
public static void TR_public enumerateEntitiesHull(float[] pos[3],
                                    float[] vec[3],
                                    float[] mins[3],
                                    float[] maxs[3],
                                    int mask,
 ...
 * @param data          Arbitrary data value to pass through to the public enumerator.
 */
public static void TR_public enumerateEntitiesSphere(float[] pos[3],
                                    float radius,
                                    int mask,
                                    TraceEntitypublic enumerator public enumerator,
                                    any data=0) { throw new NotImplementedException(); }
 ...
 * @param data          Arbitrary data value to pass through to the public enumerator.
 */
public static void TR_public enumerateEntitiesBox(float[] mins[3],
                                    float[] maxs[3],
                                    int mask,
                                    TraceEntitypublic enumerator public enumerator,
                                    any data=0) { throw new NotImplementedException(); }
 ...
 * @param data          Arbitrary data value to pass through to the public enumerator.
 */
public static void TR_public enumerateEntitiesPoint(float[] pos[3],
                                    int mask,
                                    TraceEntitypublic enumerator public enumerator,
                                    any data=0) { throw new NotImplementedException(); }
 ...
 *                      function.
 */
public static void TR_TraceRayFilter(float[] pos[3],
                              float[] vec[3],
                              int flags,
                              RayType rtype,
 ...
 *                      function.
 */
public static void TR_TraceHullFilter(float[] pos[3],
                               float[] vec[3],
                               float[] mins[3],
                               float[] maxs[3],
                               int flags,
 ...
 */
public static void TR_ClipRayToEntity(float[] pos[3],
                               float[] vec[3],
                               int flags,
                               RayType rtype,
                               int entity) { throw new NotImplementedException(); }
 ...
 * @param entity        Entity to clip to.
 */
public static void TR_ClipRayHullToEntity(float[] pos[3],
                                   float[] vec[3],
                                   float[] mins[3],
                                   float[] maxs[3],
                                   int flags,
 ...
 */
public static Handle TR_TraceRayEx(float[] pos[3],
                            float[] vec[3],
                            int flags,
                            RayType rtype) { throw new NotImplementedException(); }
 ...
 * @return              Ray trace handle, which must be closed via CloseHandle().
 */
public static Handle TR_TraceHullEx(float[] pos[3],
                             float[] vec[3],
                             float[] mins[3],
                             float[] maxs[3],
                             int flags) { throw new NotImplementedException(); }
 ...
 * @return              Ray trace handle, which must be closed via CloseHandle().
 */
public static Handle TR_TraceRayFilterEx(float[] pos[3],
                                  float[] vec[3],
                                  int flags,
                                  RayType rtype,
                                  TraceEntityFilter filter,
 ...
 * @return              Ray trace handle, which must be closed via CloseHandle().
 */
public static Handle TR_TraceHullFilterEx(float[] pos[3],
                                   float[] vec[3],
                                   float[] mins[3],
                                   float[] maxs[3],
                                   int flags,
 ...
 * @return              Ray trace handle, which must be closed via CloseHandle().
 */
public static Handle TR_ClipRayToEntityEx(float[] pos[3],
                                   float[] vec[3],
                                   int flags,
                                   RayType rtype,
                                   int entity) { throw new NotImplementedException(); }
 ...
 * @return              Ray trace handle, which must be closed via CloseHandle().
 */
public static Handle TR_ClipRayHullToEntityEx(float[] pos[3],
                                       float[] vec[3],
                                       float[] mins[3],
                                       float[] maxs[3],
                                       int flags,
