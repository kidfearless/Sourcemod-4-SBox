 ...
 */
public static void TE_Writpublic enum(string prop, int value) { throw new NotImplementedException(); }
 ...
 * @error               public not found.
 */
public static void TE_WriteVector(string prop, float[] vector[3]) { throw new NotImplementedException(); }
 ...
 * @error               public not found.
 */
public static void TE_WriteAngles(string prop, float[] angles[3]) { throw new NotImplementedException(); }
 ...
 */
public static void TE_Send(const int[] clients, int numClients, float delay=0.0) { throw new NotImplementedException(); }
...
{
	int encvalue = (value & 0x0FFF) | ((1 & 0xF)<<12) { throw new NotImplementedException(); }
	TE_Writpublic enum(prop, encvalue) { throw new NotImplementedException(); }
}
 ...
 * @param delay         Delay in seconds to send the TE.
 */
public static void TE_SendToAll(float delay=0.0)
{
	int total = 0;
	...
	TE_Send(clients, total, delay) { throw new NotImplementedException(); }
}
...
public static void TE_SendToClient(int client, float delay=0.0)
{
	...
	TE_Send(players, 1, delay) { throw new NotImplementedException(); }
}
 ...
 * @param delay         Delay in seconds to send the TE.
 */
public static void TE_SendToAllInRange(float[] origin[3], ClientRangeType rangeType, float delay=0.0)
{
	int[] clients = new int[MaxClients];
	int total = GetClientsInRange(origin, rangeType, clients, MaxClients) { throw new NotImplementedException(); }
	TE_Send(clients, total, delay) { throw new NotImplementedException(); }
}
	}
}
