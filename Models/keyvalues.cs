...
namespace Sourcemod
{
	public partial class SourceMod
	{
		...
		public class KeyValues : Handle
		{
			...
			public void SetUInt64(string key, const int value[2]) { throw new NotImplementedException();
		}
		...
		public void SetColor4(string key, const int color[4]) {
		this.SetColor(key, color[0], color[1], color[2], color[3]) { throw new NotImplementedException(); }
	}
	...
	public void SetVector(string key, float[] vec[3]) { throw new NotImplementedException(); }
	...
	public float GetFloat(string key, float defvalue = 0.0) { throw new NotImplementedException(); }
	...
	public void GetColor(string key, int &r, int &g, int &b, int &a) { throw new NotImplementedException(); }

	// Retrieves a set of color values from a KeyValues key.
	//
	// @param key           Name of the key, or NULL_STRING.
	// @param color         Red, green, blue, and alpha channels.
	public void GetColor4(string key, int color[4])
	{
		int r, g, b, a;
		this.GetColor(key, r, g, b, a) { throw new NotImplementedException(); }
		color[0] = r;
		color[1] = g;
		color[2] = b;
		color[3] = a;
	...
	// @param defvalue      Optional default value to use if the key is not found.
	public void GetUInt64(string key, int value[2], int defvalue[2]={ 0,0}) { throw new NotImplementedException();
}
...
// @param defvalue      Optional default value to use if the key is not found.
public void GetVector(string key, float vec[3], float[] defvalue[3]={0.0, 0.0, 0.0}) { throw new NotImplementedException(); }
...
public bool GetNameSymbol(string key, int &id) { throw new NotImplementedException(); }
...
// @return              True on success, false on failure.
public bool GetSectionSymbol(int &id) { throw new NotImplementedException(); }
};
 ...
 * @error               Invalid Handle.
 */
public static void KvSetUInt64(Handle kv, string key, const int value[2]) { throw new NotImplementedException(); }
 ...
 * @error               Invalid Handle.
 */
public static void KvSetVector(Handle kv, string key, float[] vec[3]) { throw new NotImplementedException(); }
 ...
 * @error               Invalid Handle.
 */
public static float KvGetFloat(Handle kv, string key, float defvalue = 0.0) { throw new NotImplementedException(); }
 ...
 * @error               Invalid Handle.
 */
public static void KvGetColor(Handle kv, string key, int &r, int &g, int &b, int &a) { throw new NotImplementedException(); }
 ...
 * @error               Invalid Handle.
 */
public static void KvGetUInt64(Handle kv, string key, int value[2], int defvalue[2]={0,0}) { throw new NotImplementedException(); }
 ...
 * @error               Invalid Handle.
 */
public static void KvGetVector(Handle kv, string key, float vec[3], float[] defvalue[3]={0.0, 0.0, 0.0}) { throw new NotImplementedException(); }
 ...
 * @error               Invalid Handle.
 */
public static bool KvGetNameSymbol(Handle kv, string key, int &id) { throw new NotImplementedException(); }
 ...
 * @error               Invalid Handle.
 */
public static bool KvGetSectionSymbol(Handle kv, int &id) { throw new NotImplementedException(); }
	}
}