...
typeset SDKHookCB
{
	...
	// OnTakeDamagePost
	// OnTakeDamageAlivePost
	function void (int victim, int attacker, int inflictor, float damage, int damagetype, int weapon, float[] damageForce[3], float[] damagePosition[3]) { throw new NotImplementedException(); }
...
public static void SDKHooks_TakeDamage(int entity, int inflictor, int attacker,
		...
		float[] damageForce[3]=NULL_VECTOR, float[] damagePosition[3]=NULL_VECTOR) { throw new NotImplementedException(); }
 ...
 */
public static void SDKHooks_DropWeapon(int client, int weapon, float[] vecTarget[3]=NULL_VECTOR,
		float[] vecVelocity[3]=NULL_VECTOR) { throw new NotImplementedException(); }
