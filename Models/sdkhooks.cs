...
//function Action(int entity, ref int maxhealth) { throw new NotImplementedException(); }

//// OnTakeDamage
//// OnTakeDamageAlive
//// SDKHooks 1.0f+
//function Action(int victim, ref int attacker, ref int inflictor, ref float damage, ref int damagetype) { throw new NotImplementedException(); }
...
//// SDKHooks 2.0f+
//function Action(int victim, ref int attacker, ref int inflictor, ref float damage, ref int damagetype, ref int weapon, float[/* 3 */] damageForce, float[/* 3 */] damagePosition) { throw new NotImplementedException(); }

//// OnTakeDamage
//// OnTakeDamageAlive
//// Note: The weapon parameter is not used by all games and damage sources.
//// Note: Force application is dependent on game and damage type(s)
//// SDKHooks 2.1f+  (can check for support at runtime using GetFeatureStatus on SDKHook_DmgCustomInOTD capability.
//// DON'T attempt to access 'damagecustom' var if feature status != available
//function Action(int victim, ref int attacker, ref int inflictor, ref float damage, ref int damagetype, ref int weapon,
...
//// OnTakeDamagePost
//// OnTakeDamageAlivePost
//function void(int victim, int attacker, int inflictor, float damage, int damagetype, int weapon, float[/*3*/] damageForce, float[/*3*/] damagePosition) { throw new NotImplementedException(); }

//// OnTakeDamagePost
//// OnTakeDamageAlivePost
//function void(int victim, int attacker, int inflictor, float damage, int damagetype, int weapon,
//	float[/*3*/] damageForce, float[/*3*/] damagePosition, int damagecustom) { throw new NotImplementedException(); }

//// FireBulletsPost
//function void(int client, int shots, string weaponname) { throw new NotImplementedException(); }

//// TraceAttack
//function Action(int victim, ref int attacker, ref int inflictor, ref float damage, ref int damagetype, ref int ammotype, int hitbox, int hitgroup) { throw new NotImplementedException(); }
...
// */
//public virtual void OnEntityDestroyed(int entity) { throw new NotImplementedException(); }
...
// */
//public virtual Action OnGetGameDescription(ref string gameDesc);
//{ throw new NotImplementedException(); }
...
// */
//public virtual Action OnLevelInit(string mapName, ref string mapEntities);
//{ throw new NotImplementedException(); }
