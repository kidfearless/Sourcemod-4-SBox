...
public const int FCVAR_SERVER_CAN_EXECUTE      =(1 << 28) ;// the server is allowed to execute this command on clients via
		 ...
		 */
public static void ServerCommand(string format, params any[] args) { throw new NotImplementedException(); }
		 ...
		 * @param ...           Variable number of format parameters.
		 */
		public static void ServerCommandEx(string buffer, int maxlen, string format, params any[] args) { throw new NotImplementedException(); }
		 ...
		 * @param ...           Variable number of format parameters.
		 */
		public static void InsertServerCommand(string format, params any[] args) { throw new NotImplementedException(); }
		 ...
		 */
		public static void ClientCommand(int client, string fmt, params any[] args) { throw new NotImplementedException(); }
		 ...
		 * @error               Invalid client index, or client not connected.
		 */
		public static void FakeClientCommand(int client, string fmt, params any[] args) { throw new NotImplementedException(); }
		 ...
		 * @error               Invalid client index, or client not connected.
		 */
		public static void FakeClientCommandEx(int client, string fmt, params any[] args) { throw new NotImplementedException(); }
		 ...
		 * @param ...           Variable number of format parameters.
		 */
		public static void PrintToServer(string format, params any[] args) { throw new NotImplementedException(); }
		 ...
		 */
		public static void PrintToConsole(int client, string format, params any[] args) { throw new NotImplementedException(); }
		 ...
		 * @param ...           Variable number of format parameters.
		 */
		public static void PrintToConsoleAll(string format, params any[] args)
		{
		 ...
		 */
		public static void ReplyToCommand(int client, string format, params any[] args) { throw new NotImplementedException(); }
		 ...
		 * @error
		 */
		public static void ShowActivity2(int client, string tag, string format, params any[] args) { throw new NotImplementedException(); }
		 ...
		 * @error
		 */
		public static void ShowActivity(int client, string format, params any[] args) { throw new NotImplementedException(); }
		 ...
		 * @error
		 */
		public static void ShowActivityEx(int client, string tag, string format, params any[] args) { throw new NotImplementedException(); }
...
/*			char str[12];
		 ...
		 */
		public static bool ReadCommandIterator(Handle iter, string name, int nameLen)
		{ throw new NotImplementedException(); }
		 ...
		 * @return              True on success, false if there are no more commands.
		 */
		public static bool ReadCommandIterator(Handle iter, string name, int nameLen, out int eflags)
		{ throw new NotImplementedException(); }
		 ...
		 * @return              True on success, false if there are no more commands.
		 */
		public static bool ReadCommandIterator(Handle iter, string name, int nameLen, out int eflags, string desc = "", int descLen = 0)
		{ throw new NotImplementedException(); }
