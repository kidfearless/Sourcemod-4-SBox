...
namespace Sourcemod
{
	public partial class SourceMod
	{
		 ...
		 */
		public static void IgniteEntity(int entity, float time, bool npc = false, float size = 0.0f, bool level = false) { throw new NotImplementedException(); }
		 ...
		 * @error               Invalid entity or client not in game, or lack of mod support.
		 */
		public static void TeleportEntity(int entity, float[/*2*/] origin = NULL_VECTOR, float[/*3*/] angles = NULL_VECTOR, float[/*3*/] velocity = NULL_VECTOR) { throw new NotImplementedException(); }
		 ...
		 * @error               Invalid entity index, or no mod support.
		 */
		public static bool DispatchKeyValueVector(int entity, string keyName, float[/*3*/] vec) { throw new NotImplementedException(); }
		 ...
		 */
		public static void GetTeamName(int index, out string name, int maxlength) { throw new NotImplementedException(); }
