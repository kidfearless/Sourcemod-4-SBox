...
namespace Sourcemod
{
	public partial class SourceMod
	{
		...
		public const float SNDVOL_NORMAL = 1.0f;    /**< Normal volume */
		...
		public const float SNDATTN_NONE = 0.0f;    /**< No attenuation */
		public const float SNDATTN_NORMAL = 0.8f;    /**< Normal attenuation */
		public const float SNDATTN_STATIC = 1.25f;    /**< Static attenuation? */
		public const float SNDATTN_RICOCHET = 1.5f;    /**< Ricochet effect */
		public const float SNDATTN_IDLE = 2.0f;    /**< Idle attenuation? */
		 ...
		 * @param vol           Volume (from 0.0f to 1.0).
		 * @param pitch         Pitch (from 0 to 255).
		 * @param delay         Play delay.
		 */
		public static void EmitAmbientSound(string name, float[/*3*/] pos, int entity = SOUND_FROM_WORLD, int level = SNDLEVEL_NORMAL, int flags = SND_NOFLAGS, float vol = SNDVOL_NORMAL, int pitch = SNDPITCH_NORMAL, float delay = 0.0f)
		...
		public static void EmitSound(/*const*/ int[] clients,
				 ...
				 int speakerentity = -1,
				 float[/*3*/] origin = NULL_VECTOR,
				 float[/*3*/] dir = NULL_VECTOR,
				 bool updatePos = true,
		 ...
		 * @param volume        Volume (from 0.0f to 1.0).
		 * @param level         Sound level (from 0 to 255).
		 * @param pitch         Pitch (from 0 to 255).
		 * @param pos           Origin of sound.
		 * @param flags         Sound flags.
		 ...
		 */
		public delegate Action AmbientSHook(ref string sample, ref int entity, ref float volume, ref int level, ref int pitch, float[/* 3 */] pos, ref int flags, ref float delay);
		...
		// @return              Plugin_Continue to allow the sound to be played, Plugin_Stop to block it,
		//                      Plugin_Changed when any parameter has been modified.
		public delegate Action NormalSHook(int[/* MAXPLAYERS */] clients, out int numClients, ref string sample, out int entity, out int channel, out float volume, out int level, out int pitch, out int flags, ref string soundEntry, out int seed);
		...
		public static int ATTN_TO_SNDLEVEL(float attn)
		{
			if (attn > 0.0f)
			{
				return RoundFloat(50.0f + (20.0f / attn));
			}
			return 0;
		}
						...
						float soundtime = 0.0f)
		{
			...
			if (GetGameSoundParams(gameSound, out channel, out level, out volume, out pitch, out sample, -1, entity))
			{
