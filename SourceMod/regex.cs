...
namespace Sourcemod
{
	public partial class SourceMod
	{
		...
		public class Regex : Handle
		{
			...
			// @param maxLen        Maximum string length of the error buffer.
			// @param errcode       Regex type error code encountered, if applicable.
			public Regex(string pattern, int flags = 0, string error = "", int maxLen = 0) { throw new NotImplementedException(); }
			// Compile a regular expression.
			//
			// @param pattern       The regular expression pattern.
			// @param flags         General flags for the regular expression.
			...
			// @param maxLen        Maximum string length of the error buffer.
			// @param errcode       Regex type error code encountered, if applicable.
			public Regex(string pattern, int flags = 0, string error = "") { throw new NotImplementedException(); }
			// Compile a regular expression.
			//
			// @param pattern       The regular expression pattern.
			// @param flags         General flags for the regular expression.
			...
			// @param maxLen        Maximum string length of the error buffer.
			// @param errcode       Regex type error code encountered, if applicable.
			public Regex(string pattern, int flags = 0) { throw new NotImplementedException(); }
			// Compile a regular expression.
			//
			// @param pattern       The regular expression pattern.
			// @param flags         General flags for the regular expression.
			...
			// @note Use the regex handle passed to this function to extract
			//       matches with GetSubString().
			public int Match(string str) { throw new NotImplementedException(); }
			...
			//
			// @note Use GetSubString() and loop from 0 -> totalmatches - 1.
			public int MatchAll(string str) { throw new NotImplementedException(); }
		 ...
		 */
		public static Regex CompileRegex(string pattern, int flags, string error, int maxLen, out RegexError errcode/* = REGEX_ERROR_NONE*/) { throw new NotImplementedException(); }
		 ...
		 * @return              Valid regex handle on success, INVALID_HANDLE on failure.
		 */
		public static Regex CompileRegex(string pattern, int flags = 0, string error = "", int maxLen = 0) { throw new NotImplementedException(); }
